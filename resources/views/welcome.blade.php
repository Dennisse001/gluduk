...
<head>
  ...
  <title>PAWRFECT</title>
  <link rel="icon" href="{{ asset('pawrfect.png') }}" type="image/png">
  <!-- -------- anime css ------ -->
  <link rel="stylesheet" href={{ asset('tool/css/animate.css') }}>
  <!-- --------- tiny slider css ------ -->
  <link rel="stylesheet" href={{ asset('tool/css/tiny-slider.css') }}>
  <!-- --------- font awsome css ------ -->
  <link rel="stylesheet" href={{ asset('tool/css/all.css') }}>
  <!-- -------- venobox css ------- -->
  <link rel="stylesheet" href={{ asset('tool/css/venobox.css') }} type="text/css" media="screen" />
  <!-- ---- Bootstrap css--- -->
  <link rel="stylesheet" href={{ asset('tool/css/bootstrap.min.css') }}>
  <!-- ---------- default css --------- -->
  <link rel="stylesheet" href={{ asset('tool/css/default.css') }}>
  <!-- --- style css -->
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img class="image" src="tool/img/header/logo/pawrfect.png" style="width: 700px; height: auto;" alt="">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto">
                ...
                @if (Auth::check())
                <li class="nav-item">
                    <a class="nav-link"  href="{{ route('dash.admin') }}">Profil Saya</a>
                  </li>
                  @else
                <li class="nav-item">
...
@endif
    ...
    <div class="header-hero" data-scroll-index="0">
        ...
        <div class="row align-items-center justify-content-center justify-content-lg-between">
          <div class="col-lg-6 col-md-10">
            <div class="header-hero-content">
              <h1 class="header-title wow fadeInLeftBig" data-wow-duration="3s" data-wow-delay="0.2s"><span>Cari hewan peliharaan</span> Yang pasti Imut dan Menawan</h1>
              <p class="text wow fadeInLeftBig" data-wow-duration="3s" data-wow-delay="0.4s">Pawrfect website andalan untuk mencari partner anda yang siap menemani anda kapan pun dimanapun. Baik dalam keadaan senang maupun susah</p>
              <ul class="d-flex">
                <li><a href="" class="main-btn wow fadeInLeftBig" data-wow-duration="3s" data-wow-delay="0.8s">Mulai
                    Sekarang</a></li>
                <li><a href="https://youtu.be/5TyDk2PAaJ4" class="header-video venobox wow fadeInLeftBig"
          ...
          <div class="col-lg-6 col-md-6">
            <div class="header-image">
              <img src="tool/img/header/header-app.png" alt="" class="image-1  wow fadeInRightBig"
      ...
      <div class="container">
        ...
        <div class="header-shape-2">
          <img src="tool/img/header/header-shape-2.svg" alt="">
        </div>
      </div>
    </div>
    <!---- home star ------>
      ...
      <div class="row justify-content-center">
        <div class="col-xl-6 col-lg-7">
          <div class="section-title text-center mb-30">
            <h1 class="mb-25  wow fadeInUp" data-wow-delay=".2s">Awsome <span> Features</span></h1>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="about-image wow fadeInLeftBig" data-wow-duration="3s" data-wow-delay="0.5s">
            ...
            <img src="tool/img/about/about-app.png" alt="" class="app" style="width: 1200px; height: 500px;">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="about-content mt-50 wow fadeInRightBig" data-wow-duration="3s" data-wow-delay="0.5s">
            <div class="section-title">
              <h1 class="title">Comes With All You Neede</h1>
            ...
            <div class="testimonial-active">
              <div class="testimonial-wrapper">
                <div class="single-testimonial">
                  <div class="info">
                    <div class="image-2">
                      <img src="tool/img/testemonial/test-1.jpg" alt="">
                    </div>
                    <h4>John Deo</h4>
                    <p>roduct Design</p>
                    <div class="quote">
              ...
              <div class="testimonial-wrapper">
                <div class="single-testimonial">
                  <div class="info">
                    <div class="image-2">
                      <img src="tool/img/testemonial/test-2.jpg" alt="">
                    </div>
                    <h4>John Deo</h4>
                    <p>roduct Design</p>
                    <div class="quote">
      ...
      <div class="row justify-content-center">
        <div class="xol-xl-6 col-lg-7">
          <div class="section-title text-center pb-30">
            ...
            <p class="wow fadeInUp" data-wow-delay=".4s">Lorem ipsum dolor sit amet consectetur, adipisicing elit.
              Molestias aut maxime repellendus inventore animi laboriosam.</p>
          </div>
        </div>
      </div>
      <div class="row justify-content-center">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="faq-image wow fadeInRightBig" data-wow-duration="3s" data-wow-delay="0.5s">
              <img src="tool/img/faq/faq-img.svg" alt="">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-lg-6 col-md-9">
          <div class="download-image mt-50 wow fadeInLeftBig" data-wow-duration="3s" data-wow-delay="0.5s">
            ...
            <img src="tool/img/download/download-app.png" alt="" class="image-3">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="download-content mt-45 wow fadeInRightBig" data-wow-duration="3s" data-wow-delay="0.5s">
            ...
            <ul>
              <li><a href="" class="app-store">
                  <img src="tool/img/download/app-store.png" alt="">
                </a></li>
              <li><a href="" class="play-store">
                  <img src="tool/img/download/play-store.png" alt="">
                </a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="footer-about mt-50">
              <a href="" class="logo">
                <img src="tool/img/header/logo/landapp-logo.png" alt="">
              </a>
              <p class="text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates quaerat quo obcaecati
                excepturi, iste nisi.</p>
              <ul class="social">
  ...
  <!-- ---- jquery Js ---- -->
  <script src={{ asset('tool/js/jquery-1.12.4.min.js') }}></script>
  <!-- -------- venobox js ------ -->
  <script type="text/javascript" src={{ asset('tool/js/venobox.min.js') }}></script>
  <!-- ---------- wow js ---------- -->
  <script src={{ asset('tool/js/wow.min.js') }}></script>
  <!-- ---------- tiny slider js --------- -->
  <script src={{ asset('tool/js/tiny-slider.js') }}></script>
  <!-- ---------- scrollit js ---------- -->
  <script src={{ asset('tool/js/scrollIt.min.js') }}></script>
  <!-- -------- font awsome js --------- -->
  <script src={{ asset('tool/js/all.js') }}></script>
  <!-- ---- Bootstrap Js ---- -->
